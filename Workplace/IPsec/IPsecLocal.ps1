...
$Phase1Auth = New-NetIPsecPhase1AuthSet -DisplayName "SHLTH Machine Cert Auth" -Proposal $MachineCertProp
...
$Phase2Auth = New-NetIPsecPhase2AuthSet -DisplayName "SHLTH User Cert+Kerberos Auth" -Proposal $UserCertProp, $UserKerbProp
