...
$Form.ClientSize = New-Object System.Drawing.Point(485, 285)
...
$tbSource.Width = 390
$tbSource.Height = 30
$tbSource.Location = New-Object System.Drawing.Point(10, 5)
$tbSource.TabIndex = 0
...
$rbFrom.Location = New-Object System.Drawing.Point(120, 40)
$rbFrom.TabIndex = 1
$rbFrom.Font = New-Object System.Drawing.Font('Segoe UI', 13)
$Comps += $rbFrom
...
$rbTo.Checked = $true
$rbTo.AutoSize = $true
$rbTo.Location = New-Object System.Drawing.Point(220, 40)
$rbTo.TabIndex = 2
$rbTo.Font = New-Object System.Drawing.Font('Segoe UI', 13)
$Comps += $rbTo
...
$tbDest.Width = 390
$tbDest.Height = 30
$tbDest.Location = New-Object System.Drawing.Point(10, 75)
$tbDest.TabIndex = 3
...
$btnBrowse.Width = 70
$btnBrowse.Height = 30
$btnBrowse.Location = New-Object System.Drawing.Point(405, 75)
...
$tbFilter.Width = 465
$tbFilter.Height = 30
$tbFilter.Location = New-Object System.Drawing.Point(10, 110)
$tbFilter.TabIndex = 5
$tbFilter.Text = "*"
$Comps += $tbFilter
...
$cbxRecusive.Location = New-Object System.Drawing.Point(10, 145)
...
$cbxPurge.Location = New-Object System.Drawing.Point(135, 145)
$cbxPurge.TabIndex = 7
$Comps += $cbxPurge
...
$cbxCopyAcl.Location = New-Object System.Drawing.Point(260, 145)
...
$cbxExHidden.Location = New-Object System.Drawing.Point(10, 180)
...
$cbxPreSym.Location = New-Object System.Drawing.Point(135, 180)
...
$cbxPreJunc.Location = New-Object System.Drawing.Point(260, 180)
...
$cbxElevate.Location = New-Object System.Drawing.Point(10, 215)
...
$cbxLogging.Location = New-Object System.Drawing.Point(135, 215)
...
$cbxMonitor.Location = New-Object System.Drawing.Point(260, 215)
...
$nudMonitor.Location = New-Object System.Drawing.Point(385, 215)
...
$btnOK.Width = 120
$btnOK.Height = 30
$btnOK.Location = New-Object System.Drawing.Point(10, 250)
...
$btnCancel.Width = 120
$btnCancel.Height = 30
$btnCancel.Location = New-Object System.Drawing.Point(135, 250)
...
{
    if ($rbFrom.Checked) { $param = "`"$($tbDest.Text)`" `"$SrcDir`" $($tbFilter.Text)" }
    else { $param = "`"$SrcDir`" `"$($tbDest.Text)`" $($tbFilter.Text)" }
